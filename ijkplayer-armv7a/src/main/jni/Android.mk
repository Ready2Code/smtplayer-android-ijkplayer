...
#-----MMTtool-----
MY_APP_MMTTOOL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/MMTtool-armv7a/output)
MY_APP_MMTTOOL_INCLUDE_PATH := $(realpath $(MY_APP_MMTTOOL_OUTPUT_PATH)/include)
endif
...
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_MMTTOOL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/MMTtool-arm64/output)
MY_APP_MMTTOOL_INCLUDE_PATH := $(realpath $(MY_APP_MMTTOOL_OUTPUT_PATH)/include)
endif
ifeq ($(TARGET_ARCH_ABI),x86)
MY_APP_FFMPEG_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/ffmpeg-x86/output)
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_MMTTOOL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/MMTtool-x86/output)
MY_APP_MMTTOOL_INCLUDE_PATH := $(realpath $(MY_APP_MMTTOOL_OUTPUT_PATH)/include)
endif
ifeq ($(TARGET_ARCH_ABI),x86_64)
MY_APP_FFMPEG_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/ffmpeg-x86_64/output)
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_MMTTOOL_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/MMTtool-x86_64/output)
MY_APP_MMTTOOL_INCLUDE_PATH := $(realpath $(MY_APP_MMTTOOL_OUTPUT_PATH)/include)
endif
